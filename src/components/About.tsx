...
export default function About() {
    return (
        <section
            id="about"
            className="flex flex-col items-center py-[60px] lg:py-[120px] px-[20px] lg:px-[152px] gap-[60px] lg:gap-[120px] w-full"
            style={{
                background: "linear-gradient(180deg, #111111 10%, rgba(95, 0, 219, 0.25) 50%, #111111 90%)",
            }}
        >
            {/* Row 1: About Us */}
            <div className="flex flex-col lg:flex-row justify-center items-start p-0 gap-[40px] lg:gap-[80px] w-full max-w-[1616px]">
                {/* Image */}
                <div className="relative w-full lg:w-1/2 h-[400px] lg:h-[611px] flex-none order-0 self-stretch shrink-0">
                    <Image
                ...
                {/* Content */}
                <div className="flex flex-col items-start p-0 gap-[24px] lg:gap-[40px] w-full lg:w-1/2 min-h-auto lg:h-[611px] flex-none order-1">
                    <h2 className="w-full text-white font-bold text-[24px] lg:text-[32px] leading-[120%] tracking-[-0.04em] flex items-center">
                        About Us
                    </h2>
                    <h1 className="w-full text-white font-bold text-[40px] lg:text-[64px] leading-[110%] tracking-[-0.04em] flex items-center">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-start p-0 gap-[40px] lg:gap-[80px] w-full max-w-[1616px]">
                {/* Content Box */}
                <div className="flex flex-col items-start p-[24px] lg:p-[40px] gap-[24px] lg:gap-[40px] w-full lg:w-1/2 min-h-auto lg:h-[706px] bg-[#5F00DB] rounded-[40px] flex-none order-1 lg:order-0">
                    <h2 className="w-full text-white font-bold text-[24px] lg:text-[32px] leading-[120%] tracking-[-0.04em] flex items-center">
                        Our Mission
                    </h2>
                    <h3 className="w-full text-white font-bold text-[32px] lg:text-[48px] leading-[110%] tracking-[-0.04em] flex items-center">
                ...
                {/* Image */}
                <div className="relative w-full lg:w-1/2 h-[400px] lg:h-[706px] flex-none order-0 lg:order-1 self-stretch shrink-0">
                    <Image
            ...
            <div className="flex flex-col lg:flex-row justify-center items-start p-0 gap-[40px] lg:gap-[80px] w-full max-w-[1616px]">
                {/* Image */}
                <div className="relative w-full lg:w-1/2 h-[400px] lg:h-[677px] flex-none order-0 self-stretch shrink-0">
                    <Image
                ...
                {/* Content Box */}
                <div className="flex flex-col items-start p-[24px] lg:p-[40px] gap-[24px] lg:gap-[40px] w-full lg:w-1/2 min-h-auto lg:h-[677px] bg-[#16003F] rounded-[40px] flex-none order-1">
                    <h2 className="w-full text-white font-bold text-[24px] lg:text-[32px] leading-[120%] tracking-[-0.04em] flex items-center">
                        Our Vision
                    </h2>
                    <h3 className="w-full text-white font-bold text-[32px] lg:text-[48px] leading-[110%] tracking-[-0.04em] flex items-center">
